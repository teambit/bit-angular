...
export async function ngBabelLinker(): Promise<typeof import('@angular/compiler-cli/linker/babel')> {
  const babelLinker = await new Function(`return import('@angular/compiler-cli/linker/babel/index.js');`)();

  return babelLinker.createEs2015LinkerPlugin ? babelLinker : babelLinker.default;
}

export async function ngccCompilerCli(): Promise<typeof import('@angular/compiler-cli/ngcc')> {
  const compilerCliModule = await new Function(`return import('@angular/compiler-cli/ngcc/index.js');`)();
...
export async function ngtscFileSystemCompilerCli(): Promise<typeof import('@angular/compiler-cli/src/ngtsc/file_system')> {
  const compilerCliModule = await new Function(`return import('@angular/compiler-cli/src/ngtsc/file_system/index.js');`)();
