...
Set an Angular Environment by adding the following line in your workspace.jsonc file, to apply the Angular development environment on all components in this workspace.
```bash
