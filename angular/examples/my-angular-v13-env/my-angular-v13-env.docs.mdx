...
<EnvOverview
  ...
  logo={{
    name: 'Angular my-angular-v13-env',
    icon: 'https://static.bit.dev/brands/logo-angular.svg',
    background: '#0d47a1'
  }}
  envId='bitdev.angular/envs/my-angular-v13-env'
    ...
    developmentTools: [
      {
        name: 'Jest',
        configFiles: [
          'https://bit.cloud/bitdev/angular/envs/my-angular-v13-env/~code/jest/jest.config.ts',
        ],
      },
      {
        name: 'ESLint',
