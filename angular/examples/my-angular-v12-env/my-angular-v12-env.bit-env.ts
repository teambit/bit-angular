...
import { AngularV12Env } from '@bitdev/angular.envs.angular-v12-env';
...
export class MyAngularV12Env extends AngularV12Env {
  // Name of the environment, used for friendly mentions across bit
  name = 'my-angular-v12-env';
...
export default new MyAngularV12Env();
