...
envId='bitdev.angular/envs/angular-v19-env'
  ...
  developmentTools: [
    {
      name: 'Jest',
      configFiles: [
        'https://bit.cloud/bitdev/angular/envs/angular-v19-env/~code/jest/jest.config.ts',
      ],
    },
    {
      name: 'ESLint',
    ...
    },
    {
      name: 'Jest',
      configFiles: [
        'https://bit.cloud/bitdev/angular/envs/angular-v19/~code/jest/jest.config.ts',
      ],
    },
  ],
    previewsAndDocs: [
