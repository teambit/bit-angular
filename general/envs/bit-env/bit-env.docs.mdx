---
description: 'An ESM environment for Bit envs.'
labels: ['env', 'node', 'dev', 'vite', 'typescript']
---

A reusable ESM development environment for Bit envs.
Use this environment to create new env components.
...
```
bit env set my-component bitdev.general/envs/bit-env
```
...
```
bit new node my-workspace --aspect bitdev.general/envs/bit-env
```
